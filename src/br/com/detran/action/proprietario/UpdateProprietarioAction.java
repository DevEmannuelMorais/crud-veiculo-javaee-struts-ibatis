...
public class UpdateProprietarioAction extends Action{
//	private SqlMapClient sqlMapClient;

	public UpdateProprietarioAction() throws IOException {
		super();
...
//		sqlMapClient = SqlMapClientBuilder.buildSqlMapClient(reader);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if(param == null) {
			...
			proprietario.setId(proprietarioForm.getId());
			proprietarioDAO.update(proprietario);
			return mapping.findForward("update");
		} else {
			proprietario = proprietarioDAO.findById(proprietarioForm.getId());
